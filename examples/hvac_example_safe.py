...
#This corresponds to the P2 unsafe hyper-property in our paper resulting in the system being safe
...
#safety property
unsafe_formula = Or((And(variable_dict['temperature'][0]>=variable_dict['temperature'][1],((variable_dict['temperature'][0]-variable_dict['temperature'][1])>10))),(And((variable_dict['temperature'][1]>variable_dict['temperature'][0]),(variable_dict['temperature'][1]-variable_dict['temperature'][0]>10))))
